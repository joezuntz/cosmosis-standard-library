...
def setup(options):
	...
	lmax_ke = options.get_double(option_section, "lmax_kappa_shear", default=0.)
	lmin_ke = options.get_double(option_section, "lmin_kappa_shear", default=0.)
	
	nlbin_kn = options.get_int(option_section, "nlbin_kappa_position", default=0)
	lmax_kn = options.get_double(option_section, "lmax_kappa_position", default=0.)
	lmin_kn = options.get_double(option_section, "lmin_kappa_position", default=0.)
