...
.. 4.2 SALT2 light-curve model uncertainties
...
[cosmomc] software. We also deliver an independent c++ code to compute
the JLA likelihood, intermediate products and presentation material.
...
=========================================
  ...
  [jla_likelihood_v3.tgz]. The code prerequisites working implementation
  ...
  Running this test should perform an evaluation of the JLA likelihood
  for the best-fit LCDM model. The expected result is approximately
  682.9.
