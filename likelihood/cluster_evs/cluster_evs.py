...
def massfunction(m,zz,rbs):
	z=round(zz,2)
	return (rbs.ev(m,z)) # This spline can be produce Nan or negative values for fm below if the mf has been saved on a coarse grid. soln is to increase nsteps in massfunction module
