module comm_gauss_br_mod
  ...
  ! JAZ - This is only a tiny modifiction to the original code from the plc-2.0, to make it
  ! return the theory prediction as well as the likelihood in comm_gauss_br_compute_lnL
...
contains
  ...
  function comm_gauss_br_compute_lnL(cls, handle, x)
    implicit none
