...
prefix = "./"
includes = [nm.get_include(), prefix + "/include", "src/",
            "src/python/clik", "src/plik/"]
defines = [("HAS_LAPACK", None), ("LAPACK_CLIK", None),
           ("NOHEALPIX", None), ("CLIK_LENSING", None)]
options = {}
...
setup(name='clik',
      ...
      ext_modules=[Extension("clik.lkl", ["src/python/clik/lkl.pyx"], **options),
                   Extension("clik.lkl_lensing", [
                       "src/python/clik/lkl_lensing.pyx"], **options),
                   Extension("clik.parametric", [
                       "src/python/clik/parametric.pyx"], **options),
                   Extension("clik.rel2015", [
                       "src/plik/component_plugin/rel2015/rel2015.pyx"], **options)
                   ],
