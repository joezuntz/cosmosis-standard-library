...
def options(ctx):
    ...
    grp.add_option("--lapack_mkl_version", action="store", default="",
                   help="version of the mkl lib (should be 10.3, 10.2, 10.1 or 10.0)")
    grp.add_option("--lapack_apple", action="store_true",
                   default=False, help="use apple version of blas/lapack")
