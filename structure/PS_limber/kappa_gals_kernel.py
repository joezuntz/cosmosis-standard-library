...
def wint(z, chiz, dndzfun, chispline):
    tmp = dndzfun(z) * (1. - chiz / chispline(z))
    return tmp
...
class kern():
    ...
    def __init__(self, zdist, dndzfun, omm, h0, xlss):
    ...
    def w_lxz(self, l, x, z):
       ...
       '''
        ...
        if (z < self.zmax / 1.0001):
            ...
            tmp = scipy.integrate.quad(wint, z, zmax / 1.0001, args=(chiz, dndzfun, chispline), limit=90)
