*** Sheth&Tormen's Halo Mass Function ***
...
and simply "./make"
- It will generate executables called "sample," "sample_mf_shethtormen" and
"compute_mf_shethtormen2"

=========================================================================
A simple program to use "mf_shethtormen.f90" (also included as "sample.f90" in
this directory):
...
Another program, "compute_mf_shethtormen.f90", for generating dn/dlnRh and dn/dlnMh 
...
An extended version, "compute_mf_shethtormen2.f90", computes dn/dlnRh and dn/dlnMh 
